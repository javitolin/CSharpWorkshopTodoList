...
namespace FourthDayDemo
{
    class App
    {
        ITaskManager TaskManager = new FileSystemTaskManager(new FileSystem());
        ...
        private void TaskManagerOnTaskAdded(TaskItem task)
        {
        ...
        async Task AddTaskAsync(CancellationToken cancellationToken)
        {
        ...
        async Task ListTasksAsync(CancellationToken cancellationToken)
        {
        ...
        async Task DeleteTaskAsync(CancellationToken cancellationToken)
        {
