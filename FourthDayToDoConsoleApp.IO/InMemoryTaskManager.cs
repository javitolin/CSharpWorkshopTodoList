...
namespace FourthDayToDoConsoleApp
{
    public class InMemoryTaskManager : ITaskManager
    {
        ...
        Task ITaskManager.AddTask(TaskItem task)
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<TaskItem>> ITaskManager.GetAllTasks()
        {
            throw new NotImplementedException();
        }

        Task<TaskItem?> ITaskManager.GetTaskById(Guid taskId)
        {
            throw new NotImplementedException();
        }

        Task<bool> ITaskManager.RemoveTask(Guid taskId)
        {
            throw new NotImplementedException();
        }

        Task<bool> ITaskManager.UpdateTask(Guid taskId, TaskItem updatedTask)
        {
            throw new NotImplementedException();
        }
    }
